...
const mentors = [
    {id:1,name:'Ana Paredes',career:'Ingeniería de Software',specialty:'Desarrollo web, React',bio:'Mentora con 4 años de experiencia en proyectos fullstack.',rating:4.8,ratingsCount:28},
    {id:2,name:'Carlos Ruiz',career:'Ciencias de la Computación',specialty:'Algoritmos y estructuras de datos',bio:'Preparación para cursos básicos y competencias.',rating:4.6,ratingsCount:21},
    {id:3,name:'Lucía Gómez',career:'Diseño Gráfico',specialty:'UX/UI, Figma',bio:'Acompaño en portafolio y entrevistas de trabajo.',rating:4.9,ratingsCount:31},
    {id:4,name:'Diego Morales',career:'Ingeniería de Datos',specialty:'Python, ML básico',bio:'Introducción a machine learning y pipelines de datos.',rating:4.7,ratingsCount:15}
];
...
function renderMentors(list){
    ...
    el.innerHTML = `
        <div class="avatar" aria-hidden>${m.name.split(' ').map(n=>n[0]).slice(0,2).join('')}</div>
